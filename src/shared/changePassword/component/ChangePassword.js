...
import {Alert, AlertTitle, Box, Button, FormControl,Grid, FormHelperText,Typography , IconButton, InputAdornment, InputLabel, OutlinedInput } from '@mui/material';
...
const ChangePassword = ({ token, ...others }) => {
    ...
    return (
        ...
        <SubCard
        className='tableShadow'  title={
            <Typography variant="h1" component="h2" className='mainheading' sx={{ marginTop:'10px' ,  
