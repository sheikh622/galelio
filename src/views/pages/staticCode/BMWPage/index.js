                        ...
                        <Grid container-fluid sx={{ paddingRight: '7%', paddingLeft: '2%' }}>
                            <Tooltip placement="top" title="Coming Soon">
                                <p className="des-font">
                                    The BMW Group is a world-renowned automotive manufacturer with a long history of innovation and
                                    excellence in design, performance, and sustainability. Its diverse portfolio of brands and commitment to
                                    cutting-edge technologies has positioned the company as a leader in the global automotive industry.{' '}
                                </p>
                            </Tooltip>
                        </Grid>
                    </Grid>
